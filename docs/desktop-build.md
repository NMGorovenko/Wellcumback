...
главного доверенного renderer. Игра автономная: эксперимент сетевой поездки этой
сборкой не подтверждается. [Рекомендации Electron](https://www.electronjs.org/docs/latest/tutorial/security).

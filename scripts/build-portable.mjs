...
<title>FRIENDSLOP — Вечер историй</title>
...
console.log(
  `Portable game: ${path.join(output, 'FRIENDSLOP.html')} (${(Buffer.byteLength(html) / 1024 / 1024).toFixed(1)} MiB)`,
);
